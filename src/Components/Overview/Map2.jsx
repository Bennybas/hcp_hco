...
const Map2 = () => {
  return (
    <div className="flex flex-col rounded-xl border border-gray-200 w-full h-32"> {/* Reduced height */}
      <ComposableMap projection="geoAlbersUsa" width={400} height={300}> {/* Adjusted width and height */}
